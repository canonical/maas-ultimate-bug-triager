...
_PROMPT_TEMPLATE = (
    ...
    "MAAS project.\n"
    "\n"
    "Analyze the following bug report and determine whether it is "
    "properly triaged. If not, suggest actions to triage it.\n"
    "\n"
    "## Bug Report\n"
    "- **ID**: {bug_id}\n"
    "- **Title**: {bug_title}\n"
    ...
    "- is_triaged: boolean — whether the bug has enough information "
    "to be considered triaged\n"
    "- reasoning: string — your assessment of the bug's triage state\n"
